            ...
            <div key={product.id} className="p-5 border border-gray-100 rounded-2xl hover:shadow-xl transition-all duration-300 group relative">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <button className="w-8 h-8 bg-gray-100 rounded-full hover:bg-gray-200">-</button>
                    <span>1</span>
                    <button className="w-8 h-8 bg-gray-100 rounded-full hover:bg-gray-200">+</button>
                </div>
              </div>
              <button className="w-full mt-4 text-sm font-bold text-gray-400 hover:text-amber-500">Add to Cart</button>
            </div>
          ))}
        </div>
      </div>
              ...
              <SwiperSlide key={product.id}>
                <div className="p-5 border border-gray-100 rounded-2xl hover:shadow-lg transition-all duration-300 relative">
                  ...
                  <div className="flex items-center justify-between gap-2">
                      <button className="text-sm font-bold text-gray-400 hover:text-gray-900">Add to Cart</button>
                  </div>
                </div>
              </SwiperSlide>
            ))}
