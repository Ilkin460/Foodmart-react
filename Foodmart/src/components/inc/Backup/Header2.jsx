    ...
    <header className="w-full bg-white font-sans sticky top-0 z-50 shadow-sm">
      ...
      <div className="max-w-360 mx-auto px-6 md:px-12 py-5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 md:gap-6">
          ...
          {/* Sepet Tetikleyici */}
          <div 
            className="text-left pl-2 cursor-pointer group select-none" 
      ...
      {opensebet && (
        <>
          ...
          />
          <div className="fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-[101] p-6 transition-transform duration-300">
